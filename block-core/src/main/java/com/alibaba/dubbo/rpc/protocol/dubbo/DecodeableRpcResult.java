 ...
 */
public class DecodeableRpcResult extends RpcResult implements Codec, Decodeable,BlockContextable {
    ...
    public Object decode(Channel channel, InputStream input) throws IOException {
        ...
        switch (flag) {
            case DubboCodec.RESPONSE_NULL_VALUE:
				try {
					setInvokeContext((BlockInvokeContext)in.readObject());
				} catch (ClassNotFoundException e1) {
					throw new IOException(StringUtils.toString(e1));
				}
                break;
