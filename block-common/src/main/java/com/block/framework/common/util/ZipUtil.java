...
import com.block.framework.common.exception.ParameterException;
...
public class ZipUtil {
    ...
    {    
        ...
        {    
            throw new ParameterException(ResultCode.ERRORINFO.PARAMEMPTY);    
        }    
        ...
        {    
            ...
            {    
                throw new ParameterException(ResultCode.ERRORINFO.PARAMEMPTY, "zipPath must not be the child directory of srcPath.");    
            }    
